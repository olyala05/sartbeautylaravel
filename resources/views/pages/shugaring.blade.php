                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-3 col-md-4">
                            <div class="sticky-top">
                                <ul class="service-list m-b30">
                                    ...
                                    <li class="active"><a href="{{ route('pages.shugaring') }}" class="dez-page"
                                            title="Şeker Ağda">Şeker
                                            Ağda</a></li>
                        ...
                        <div class="col-lg-9 col-md-8">
                            <b class="m-t0 m-b10 fw6 text-primary" style="font-size: 1.9em;">Şeker Ağda</b>
                            <p>Şeker Ağda hem kısa hem de uzun vadede cildinizi pürüzsüzleştiren ve tüylerin daha ince
                                çıkmasını sağlayan etkili bir yöntemdir. S Art Beauty Center’a gelerek şeker ağda
                                ...
                                <div class="item">
                                    <div class="dlab-box service-iconbox" style="margin-right: 20px;">
                                        <div class="dlab-media dlab-img-overlay5"> <a href="#"
                                                title="Şeker Ağda Uygulaması"><img
                                                    src="/images/sart/img_agda/seker_agda_kisa_yeni3.jpg"
                                                    alt="Şeker Ağda Uygulaması"></a> </div>
                                        <div class="dlab-info p-a30 p-t60 border-1 bg-white text-center"
                                            ...
                                            <h6 class="dlab-title m-t0"><a href="#"
                                                    title="Şeker Ağda Uygulaması">Uzun Süreli Etki</a></h6>
                                            <p class="m-b15">Kıl köklerini alarak uzun süreli sonuçlar sağlar.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="dlab-box service-iconbox" style="margin-right: 20px;">
                                        <div class="dlab-media dlab-img-overlay5"> <a href="#"
                                                title="Şeker Ağda Uygulaması"><img
                                                    src="/images/sart/img_agda/agda-uzun2.jpg" alt="Şeker Ağda Uygulaması"
                                        ...
                                        <div class="dlab-info p-a30 p-t60 border-1 bg-white text-center"
                                            ...
                                            <h6 class="dlab-title m-t0"><a href="#"
                                                    title="Şeker Ağda Uygulaması">Pürüzsüzlük</a></h6>
                                            <p class="m-b15">Ölü hücrelerin giderilmesiyle cilt canlanır.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="dlab-box service-iconbox" style="margin-right: 20px;">
                                        ...
                                        <div class="dlab-info p-a30 p-t60 border-1 bg-white text-center"
                                            ...
                                            <h6 class="dlab-title m-t0"><a href="#"
                                                    title="Şeker Ağda Uygulaması">Sağlıklı Bir Cilt</a></h6>
                                            <p class="m-b15">Cilt tahrişi ve batıkları engeller.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <br>
                            <h2 style="font-size: 1em; margin-bottom: 0.3em;">Pürüzsüz Bir Cilt İçin Şeker Ağda</h2><br>

                            <h3 style="font-size: 1em; margin-bottom: 0.1em;">Profesyonel Şeker Ağda Hizmeti</h3><br>
                            Şeker Ağda hizmetleri, kişiye özel ihtiyaçlarınızı göz önünde bulundurarak sunulmaktadır. Uzman
                            personelimiz, her cilt tipine uygun tekniklerle kaliteli, hijyenik ve konforlu bir deneyim
                            sağlamaktadır.
                                        ...
                                        <div class="acod-head">
                                            <h2 style="font-size: 1em;" class="acod-title">
                                                <a href="#" data-toggle="collapse" data-target="#faq1"
                                                    ...
                                                    1. Şeker Ağda nedir?</a>
                                            </h2>
                                        </div>
                                        <div id="faq1" class="acod-body collapse show" data-parent="#accordion1"
                                            style="">
                                            <div class="acod-content">Şeker Ağda, tamamen doğal ve hypoalerjenik bir şeker
                                                ağda türüdür. Tüyleri kökünden çeker, cildi besler ve pürüzsüz hale getirir.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="panel">
                                        <div class="acod-head">
                                            <h2 style="font-size: 1em;" class="acod-title">
                                                <a href="#" data-toggle="collapse" data-target="#faq2"
                                                    ...
                                                    2. Diğer şeker ağda yöntemlerinden nasıl farklıdır?</a>
                                            </h2>
                                        </div>
                                        <div id="faq2" class="acod-body collapse" data-parent="#accordion1"
                                            style="">
                                            <div class="acod-content">Şeker Ağda, diğer yöntemlere göre daha az acı verir,
                                                daha az tahrişe yol açar ve cildi daha az gerer.</div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="acod-head">
                                            <h2 style="font-size: 1em;" class="acod-title">
                                                <a href="#" data-toggle="collapse" data-target="#faq3"
                                                    class="collapsed" aria-expanded="false">
                                                    3.Şeker Ağdanın etkileri ne kadar sürer?</a>
                                            </h2>
                                        </div>
                                        <div id="faq3" class="acod-body collapse" data-parent="#accordion1"
                                            style="">
                                            <div class="acod-content">Genellikle sonuçlar 3 ila 6 hafta boyunca kalıcıdır.
                                                Bu süre cilt tipinize bağlı olarak değişebilir.</div>
                                        </div>
                                    </div>
                                    <div class="panel">
                                        <div class="acod-head">
                                            <h2 style="font-size: 1em;" class="acod-title">
                                                <a href="#" data-toggle="collapse" data-target="#faq4"
                                                    class="collapsed" aria-expanded="false">
                                                    4.Şeker Ağda yaparken ağrı hissi olur mu? </a>
                                            </h2>
                                        </div>
                                        <div id="faq4" class="acod-body collapse" data-parent="#accordion1"
                                            style="">
                                            <div class="acod-content">Profesyonel bir şekilde uygulandığında şeker ağdanın
                                                ağrı hissi minimumdadır. Cilt hassasiyetinize göre uyarlanabilir.</div>
                                        </div>
                                    </div>
                                    <div class="panel">
                                        <div class="acod-head">
                                            <h2 style="font-size: 1em;" class="acod-title">
                                                <a href="#" data-toggle="collapse" data-target="#faq5"
                                                    class="collapsed" aria-expanded="false">
                                                    5.Şeker Ağda hizmetleri neleri içerir? </a>
                                            </h2>
                                        </div>
                                        <div id="faq5" class="acod-body collapse" data-parent="#accordion1"
                                            style="">
                                            <div class="acod-content">Hizmetlerimiz arasında bacak, kollar, yüz ve vücut
                                                için şeker ağda seçenekleri bulunur. Ayrıca cilt bakımı hizmetleri de
                                                sunuyoruz.</div>
                                        </div>
                                    </div>
                                </div>
