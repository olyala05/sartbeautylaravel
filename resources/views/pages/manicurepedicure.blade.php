        ...
        <div class="dlab-bnr-inr dlab-bnr-inr overlay-primary"
            ...
            <div class="container">
                <div class="dlab-bnr-inr-entry">
                    <h1 class="text-white">Manikür ve Pedikür</h1>
                    <!-- Breadcrumb row -->
                    <div class="breadcrumb-row">
                        <ul class="list-inline">
                            <li><a href="{{ route('route',['/']) }}" title="S Art Beauty Center Ana Sayfa" target="_self">Ana
                                    Sayfa</a>
                            </li>
                            <li>Manikür ve Pedikür</li>
                        </ul>
                    </div>
                    <!-- Breadcrumb row END -->
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-3 col-md-4">
                            <div class="sticky-top">
                                <ul class="service-list m-b30">
                                    ...
                                    <li class="active"><a href="{{ route('pages.manicurepedicure') }}" class="dez-page"
                        ...
                        <div class="col-lg-9 col-md-8">
                            <b class="m-t0 m-b10 fw6 text-primary" style="font-size: 1.9em;">Manikür ve Pedikür</b>
                            <p>Manikür ve pedikür, tırnak sağlığının korunması, bakımlı ve güzel tırnaklara sahip
                                olunabilmesi için önemlidir.</p>
                            ...
                            <div
                                ...
                                <div class="item">
                                    <div class="dlab-box service-iconbox" style="margin-right: 20px;">
                                        <div class="dlab-media dlab-img-overlay5"> <a href="#"
                                                title="Manikür ve Pedikür"><img src="/images/sart/pedikür_6.webp"
                                                    alt="Manikür ve Pedikür"></a> </div>
                                        <div class="dlab-info p-a30 p-t60 border-1 bg-white text-center"
                                            ...
                                            <h6 class="dlab-title m-t0"><a href="#"
                                                    title="Manikür ve Pedikür">Eller ve Ayaklar için Bakım</a>
                                            </h6>
                                            <p class="m-b15">Manikür ve pedikür, ellerinizin ve ayaklarınızın bakımını
                                                sağlayarak güzelliklerini öne çıkarır.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="dlab-box service-iconbox" style="margin-right: 20px;">
                                        <div class="dlab-media dlab-img-overlay5"> <a href="#"
                                                title="Manikür ve Pedikür"><img src="/images/sart/manikür_pedikür_2.webp"
                                                    alt="Manikür ve Pedikür"></a> </div>
                                        <div class="dlab-info p-a30 p-t60 border-1 bg-white text-center"
                                            style="height: 250px;">
                                            <div class="icon-bx-sm radius bg-white m-b20"> <a href="#"
                                            ...
                                            <h6 class="dlab-title m-t0"><a href="#"
                                                    title="Manikür ve Pedikür">Pürüzsüz Cilt ve Tırnaklar</a>
                                            </h6>
                                            <p class="m-b15">Düzenli manikür ve pedikür, ellerinizin daha genç ve nemli
                                                kalmasını sağlar.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="dlab-box service-iconbox" style="margin-right: 20px;">
                                        <div class="dlab-media dlab-img-overlay5"> <a href="#"
                                                title="Manikür ve Pedikür"><img src="/images/sart/manikür_pedikür_3.webp"
                                                    alt="Manikür ve Pedikür"></a> </div>
                                        <div class="dlab-info p-a30 p-t60 border-1 bg-white text-center"
                                            style="height: 250px;">
                                            <div class="icon-bx-sm radius bg-white m-b20"> <a href="#"
                                            ...
                                            <h6 class="dlab-title m-t0"><a href="#"
                                                    title="Manikür ve Pedikür">Tırnak Sağlığınızı Koruyun</a>
                                            </h6>
                                            <p class="m-b15">Tırnaklarınızı sağlıklı tutar ve enfeksiyon riskini azaltır.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <br>
                            <h2 style="font-size: 1.2em;">Manikür ve Pedikür: El ve Ayak Bakımı</h2><br>
                            <h3 style="font-size: 1.0em;">Manikür ve Pedikür Nedir?</h3>
                            Manikür; cildi yumuşatma, şekil verme parlatma, cilalama, oje sürme, tırnak derisi geriye itme,
                            tırnak diplerini ölü deriden arındırma, tırnakları törpüleme ve el masajı gibi işlemler
                            dizisidir. Pedikürde ise ayak ve ayak tırnaklarına, manikür tedavisinde olduğu gibi aynı
                            işlemler uygulanır.
                            </p>
                            ...
                            <div class="m-tb20">
                                <div class="accordion no-gap" id="accordion1">
                                        ...
                                        <div class="acod-head">
                                            <h2 style="font-size: 1em;" class="acod-title">
                                                <a href="#" data-toggle="collapse" data-target="#faq1"
                                                    ...
                                                    1. Manikür ve Pedikür Hangi Sıklıkla Yapılmalıdır?</a>
                                            </h2>
                                        </div>
                                        <div id="faq1" class="acod-body collapse show" data-parent="#accordion1"
                                            style="">
                                            <div class="acod-content">Genellikle 2 ila 4 haftada bir manikür ve pedikür
                                                yaptırmak önerilir. Tırnakların ve cildin düzenli bakımı sağlıklı sonuçlar
                                                elde etmenizi sağlar.</div>
                                        </div>
                                    </div>
                                    <div class="panel">
                                        <div class="acod-head">
                                            <h2 style="font-size: 1em;" class="acod-title">
                                                <a href="#" data-toggle="collapse" data-target="#faq2"
                                                    ...
                                                    2. Manikür ve Pedikür İşlemi Ne Kadar Sürer?</a>
                                            </h2>
                                        </div>
                                        <div id="faq2" class="acod-body collapse" data-parent="#accordion1"
                                            style="">
                                            <div class="acod-content">İşlem süresi ellere veya ayaklara göre değişebilir.
                                                Ortalama olarak 1 saat kadar sürebilir.</div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="acod-head">
                                            <h2 style="font-size: 1em;" class="acod-title">
                                                <a href="#" data-toggle="collapse" data-target="#faq3"
                                                    class="collapsed" aria-expanded="false">
                                                    3. Hangi Ürünler Kullanılır?</a>
                                            </h2>
                                        </div>
                                        <div id="faq3" class="acod-body collapse" data-parent="#accordion1"
                                            style="">
                                            <div class="acod-content">Manikürde tırnak törpüsü, cilt peelingi ve
                                                nemlendirici ürünler kullanılırken, pedikürde ayak törpüsü, cilt
                                                yumuşatıcılar ve tırnak cilası kullanılabilir.</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="panel">
                                        ...
                                        <div id="faq3" class="acod-body collapse" data-parent="#accordion1"
                                            style="">
                                            <div class="acod-content">Manikür ve pedikür işlemi genellikle acısızdır. Ancak
                                                tırnak etlerinin kesilmesi veya sert cilt bölgelerinin temizlenmesi
                                                sırasında hafif bir rahatsızlık hissedebilirsiniz.</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="panel">
                                        <div class="acod-head">
                                            <h2 style="font-size: 1em;" class="acod-title">
                                                <a href="#" data-toggle="collapse" data-target="#faq3"
                                                    class="collapsed" aria-expanded="false">
                                                    5. Hangi Durumlarda Tavsiye Edilir?</a>
                                            </h2>
                                        </div>
                                        <div id="faq3" class="acod-body collapse" data-parent="#accordion1"
                                            style="">
                                            <div class="acod-content">Manikür ve pedikür, düzenli bakım ve özel günler için
                                                idealdir. Aynı zamanda tırnaklarda kırılma, çatlama veya ciltte kuruluk gibi
                                                sorunları gidermek için de uygundur.</div>
                                        </div>
                                    </div>
