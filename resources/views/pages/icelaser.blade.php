        ...
        <div class="dlab-bnr-inr dlab-bnr-inr overlay-primary"
            ...
            <div class="container">
                <div class="dlab-bnr-inr-entry">
                    <h1 class="text-white">Buz Lazer Epilasyon</h1>
                    <!-- Breadcrumb row -->
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-md-8">
                            <b class="m-t0 m-b10 fw6 text-primary" style="font-size: 1.9em;">Buz Lazer Epilasyon</b>
                            <p>Lazer epilasyon, istenmeyen tüylerden kurtulmanın en hızlı ve en güvenli yoludur.</b></p>
                                ...
                                <div class="item">
                                    <div class="dlab-box service-iconbox" style="margin-right: 20px;">
                                        <div class="dlab-media dlab-img-overlay5"> <a href="#"
                                                title="Buz Lazer Epilasyon"><img
                                                    src="/images/sart/img_lazer/lazer-temiz-foto2.jpeg"
                                                    alt="Buz Lazer Epilasyon"></a> </div>
                                        <div class="dlab-info p-a30 p-t60 border-1 bg-white text-center"
                                            style="height: 250px;">
                                            <div class="icon-bx-sm radius bg-white m-b20"> <a href="#"
                                                    class="icon-cell" title="Buz Lazer Epilasyon"><i
                                                        class="flaticon-woman"></i></a> </div>
                                            <h6 class="dlab-title m-t0"><a href="#" title="Buz Lazer Epilasyon">Yan
                                                    Etkileri Yoktur</a></h6>
                                            <p class="m-b15">Yüksek kaliteli ekipmanlar ve güzellik uzmanlarının
                                                becerileri sayesinde yan etkileri yoktur.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="dlab-box service-iconbox" style="margin-right: 20px;">
                                        ...
                                        <div class="dlab-info p-a30 p-t60 border-1 bg-white text-center"
                                            ...
                                            <h6 class="dlab-title m-t0"><a href="#" title="Buz Lazer Epilasyon">Tüm
                                                    Tüylerden Kurtulun!</a></h6>
                                            <p class="m-b15">Tüylerinizin rengi, kalınlığı ve yapısı ne olursa olsun,
                                                hepsinden kurtulabilirsiniz.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="dlab-box service-iconbox" style="margin-right: 20px;">
                                        <div class="dlab-media dlab-img-overlay5"> <a href="#"
                                                title="Buz Lazer Epilasyon"><img src="/images/sart/img_lazer/yuzlazer.jpg"
                                                    style="height: 275px;" alt="Buz Lazer Epilasyon"></a> </div>
                                        <div class="dlab-info p-a30 p-t60 border-1 bg-white text-center"
                                            style="height: 250px;">
                                            <div class="icon-bx-sm radius bg-white m-b20"> <a href="#"
                                                    class="icon-cell" title="Buz Lazer Epilasyon"><i
                                            ...
                                            <h6 class="dlab-title m-t0"><a href="#"
                                                    title="Buz Lazer Epilasyon">Yüksek Verim</a></h6>
                                            <p class="m-b15">10-14 gün içinde dökülmeyi ve artan etkiyi fark
                                                edebilirsiniz.</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <p>
                            <h2 style="font-size: 1em;">Buz Lazer Epilasyon Nedir?</h2>
                            </p>
                            <p class="m-b20">Diyot lazer, epilasyonda 'Altın Standart' olarak kabul edilmiştir. En önemli
                                avantajlarından biri, geniş bir enerji rezervine sahip olması ve insan vücudu için maksimum
                                güvenlik ile kıl foliküllerinin yüksek verimli imhasını birleştirmesidir.
                            </p>
                                        ...
                                        <div class="acod-head">
                                            <h2 style="font-size: 1em;" class="acod-title">
                                                <a href="#" data-toggle="collapse" data-target="#faq1"
                                                    ...
                                                    1. Lazer Epilasyon Zararlı Mıdır?</a>
                                            </h2>
                                        </div>
                                        <div id="faq1" class="acod-body collapse show" data-parent="#accordion1"
                                            style="">
                                            <div class="acod-content">1. Hayır, işlem doğru şekilde yapıldığı takdirde
                                                tamamen güvenlidir.</div>
                                        </div>
                                    </div>
                                    <div class="panel">
                                        <div class="acod-head">
                                            <h2 style="font-size: 1em;" class="acod-title">
                                                <a href="#" data-toggle="collapse" data-target="#faq2"
                                                    ...
                                                    2. Hamilelik veya emzirme döneminde epilasyon yapılabilir mi?</a>
                                            </h2>
                                        </div>
                                        <div id="faq2" class="acod-body collapse" data-parent="#accordion1"
                                            style="">
                                            <div class="acod-content">2. Tavsiye edilmez.</div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="acod-head">
                                            <h2 style="font-size: 1em;" class="acod-title">
                                                <a href="#" data-toggle="collapse" data-target="#faq3"
                                                    class="collapsed" aria-expanded="false">
                                                    3. Dövmeleriniz varsa lazer epilasyon yaptırmak mümkün mü?</a>
                                            </h2>
                                        </div>
                                        <div id="faq3" class="acod-body collapse" data-parent="#accordion1"
                                            style="">
                                            <div class="acod-content">Tavsiye edilmez. Kızılötesi radyasyon, dövme boyası
                                                da dahil olmak üzere tüm koyu pigmentleri yok eder. Dövmenin solma riski
                                                vardır.</div>
                                        </div>
                                    </div>
