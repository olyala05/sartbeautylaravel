        ...
        <div class="dlab-bnr-inr dlab-bnr-inr overlay-primary"
            ...
            <div class="container">
                <div class="dlab-bnr-inr-entry">
                    <h1 class="text-white">Nail Art</h1>
                    <!-- Breadcrumb row -->
                ...
                <div class="container">
                    <div class="row">
                            ...
                            <div class="sticky-top">
                                <ul class="service-list m-b30">
                                    ...
                                    <li><a href="{{ route('pages.prostheticnails') }}" class="dez-page"
                                            ...
                                            Tırnak</a></li>
                                    <li class="active"><a href="{{ route('pages.nailart') }}" class="dez-page"
                                            title="Nail Art">Nail
                                            Art</a>
                                    </li>
                        ...
                        <div class="col-lg-9 col-md-8">
                            <b class="m-t0 m-b10 fw6 text-primary" style="font-size: 1.9em;">Nail Art</b>
                            <p>Tırnaklarınıza çeşitli renk ve desenler ekleyerek farklı bir görünüm sağlayın.</p>
                                ...
                                <div class="item">
                                    <div class="dlab-box service-iconbox" style="margin-right: 20px;">
                                        <div class="dlab-media dlab-img-overlay5"> <a href="#"
                                                title="Nail Art"><img src="/images/sart/nail_art_1.webp"
                                                    alt="Nail Art"></a> </div>
                                        <div class="dlab-info p-a30 p-t60 border-1 bg-white text-center"
                                            ...
                                            <h6 class="dlab-title m-t0"><a href="#" title="Nail Art">Renk ve
                                                    Desenler</a>
                                            </h6>
                                            <p class="m-b15">Birbirinden farklı renk ve desenlerle tarzınızı yansıtın.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="dlab-box service-iconbox" style="margin-right: 20px;">
                                        <div class="dlab-media dlab-img-overlay5"> <a href="#"
                                                title="Nail Art"><img src="/images/sart/nail_art_2.webp"
                                                    alt="Nail Art"></a> </div>
                                        <div class="dlab-info p-a30 p-t60 border-1 bg-white text-center"
                                            style="height: 250px;">
                                            <div class="icon-bx-sm radius bg-white m-b20"> <a href="#"
                                                    class="icon-cell"><i class="flaticon-mortar"></i></a> </div>
                                            <h6 class="dlab-title m-t0"><a href="#" title="Nail Art">Özel Günler
                                                    için Tasarımlar</a>
                                            </h6>
                                            <p class="m-b15">Özel günlere uygun tasarımlara sahip olabilirsiniz.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="dlab-box service-iconbox" style="margin-right: 20px;">
                                        <div class="dlab-media dlab-img-overlay5"> <a href="#"
                                                title="Nail Art"><img src="/images/sart/nail_art_3.webp"
                                                    alt="Nail Art"></a> </div>
                                        <div class="dlab-info p-a30 p-t60 border-1 bg-white text-center"
                                            style="height: 250px;">
                                            <div class="icon-bx-sm radius bg-white m-b20"> <a href="#"
                                                    class="icon-cell"><i class="flaticon-candle"></i></a> </div>
                                            <h6 class="dlab-title m-t0"><a href="#" title="Nail Art">Bakım ve
                                                    Canlılık</a>
                                            </h6>
                                            <p class="m-b15">Tırnaklarınız bakımlı ve canlı bir görünüm kazanır.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <h2 style="font-size: 1em;">Nail Art ile Renkli Tırnaklar</h2>

                            <h3 style="font-size: 1em; margin-bottom: 0.3em;">Nail Art Nedir?</h3>
                            Tırnakların farklı materyaller kullanılarak değişik renk ve figürlerde süslenmesine nail art
                            denir.

                            <h4 style="font-size: 1em; margin-bottom: 0.3em;">Profesyonel Nail Art Uygulaması:</h4>
                            Nail Art Uygulamasında, uzmanlarımız tarafından uygulanan yüksek pigmentasyona sahip ojeler ve
                            detaylı tasarımlar için özel ince uçlu fırçalar kullanılır, böylece tasarımlarda hassasiyet ve
                                        ...
                                        <div class="acod-head">
                                            <h2 style="font-size: 1em;" class="acod-title">
                                                <a href="#" data-toggle="collapse" data-target="#faq1"
                                                    ...
                                                    1. Hangi Desenler ve Süslemeler Kullanılabilir?</a>
                                            </h2>
                                        </div>
                                        <div id="faq1" class="acod-body collapse show" data-parent="#accordion1"
                                            style="">
                                            <div class="acod-content">Nail artta sınırlar yok! Çiçek desenleri, geometrik
                                                şekiller, pullar, taşlar, çıkartmalar ve daha fazlasını kullanabilirsiniz.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="panel">
                                        <div class="acod-head">
                                            <h2 style="font-size: 1em;" class="acod-title">
                                                <a href="#" data-toggle="collapse" data-target="#faq2"
                                                    ...
                                                    2. Ne Kadar Süre Kalıcıdır?</a>
                                            </h2>
                                        </div>
                                        <div id="faq2" class="acod-body collapse" data-parent="#accordion1"
                                            style="">
                                            <div class="acod-content">Nail art tasarımları, tırnaklarınızın büyüme hızına
                                                bağlı olarak genellikle 1 ila 2 hafta arasında kalıcı olabilir.</div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="acod-head">
                                            <h2 style="font-size: 1em;" class="acod-title">
                                                <a href="#" data-toggle="collapse" data-target="#faq3"
                                                    class="collapsed" aria-expanded="false">
                                                    3. Tırnaklarımı Nasıl Hazırlamalıyım?</a>
                                            </h2>
                                        </div>
                                        <div id="faq3" class="acod-body collapse" data-parent="#accordion1"
                                            style="">
                                            <div class="acod-content">Tırnaklarınızı temizleyip şekillendirmeniz yeterli.
                                                Uzmanlarımız tasarım için gerekli olan her şeyi sağlayacak.</div>
                                        </div>
                                    </div>
                                    <div class="panel">
                                        <div class="acod-head">
                                            <h2 style="font-size: 1em;" class="acod-title">
                                                <a href="#" data-toggle="collapse" data-target="#faq4"
                                                    class="collapsed" aria-expanded="false">
                                                    4. Kimler Nail Art Yaptırabilir? </a>
                                            </h2>
                                        </div>
                                        <div id="faq4" class="acod-body collapse" data-parent="#accordion1"
                                            style="">
                                            <div class="acod-content">Nail art herkes için uygundur. Özel günlerde veya
                                                günlük yaşamınızda tırnaklarınıza renk katmak isteyen herkes nail art
                                                yaptırabilir.</div>
                                        </div>
                                    </div>
                                    <div class="panel">
                                        <div class="acod-head">
                                            <h2 style="font-size: 1em;" class="acod-title">
                                                <a href="#" data-toggle="collapse" data-target="#faq5"
                                                    class="collapsed" aria-expanded="false">
                                                    5. Nasıl Bakım Yapmalıyım? </a>
                                            </h2>
                                        </div>
                                        <div id="faq5" class="acod-body collapse" data-parent="#accordion1"
                                            style="">
                                            <div class="acod-content">Nail art tasarımlarınızın uzun ömürlü olması için
                                                tırnakları sert darbelere karşı korumanız ve ojenizi düzenli olarak
                                                tazelemeniz önemlidir.</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
