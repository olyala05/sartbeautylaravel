                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="sticky-top">
                            <ul class="service-list m-b30">
                                <li><a href="{{ uniqRt('permanent-nail-polish') }}" class="dez-page" title="@lang('silk-eyelash.perminant_nail_polish')">@lang('silk-eyelash.perminant_nail_polish')</a></li>
                                <li><a href="{{ uniqRt('manicure-pedicure') }}" class="dez-page" title="@lang('silk-eyelash.mani_pedi')">@lang('silk-eyelash.mani_pedi')</a></li>
                                <li><a href="{{ uniqRt('prosthetic-nails') }}" class="dez-page" title="@lang('silk-eyelash.prosthetic_nail')">@lang('silk-eyelash.prosthetic_nail')</a></li>
                                <li><a href="{{ uniqRt('nail-art') }}" class="dez-page" title="@lang('silk-eyelash.nail_art')">@lang('silk-eyelash.nail_art')</a></li>
                                <li class="active"><a href="{{ uniqRt('silk-eyelash') }}" class="dez-page" title="@lang('silk-eyelash.silk_eyelash')">@lang('silk-eyelash.silk_eyelash')</a></li>
                                <li><a href="{{ uniqRt('eyelash-lifting') }}" class="dez-page" title="@lang('silk-eyelash.eyelash_lifting')">@lang('silk-eyelash.eyelash_lifting')</a></li>
                                <li><a href="{{ uniqRt('deepliner') }}" class="dez-page" title="@lang('silk-eyelash.dipliner')">@lang('silk-eyelash.dipliner')</a> </li>
                                <li><a href="{{ uniqRt('eyebrow-lamination') }}" class="dez-page" title="@lang('silk-eyelash.eyebrow_lamination')">@lang('silk-eyelash.eyebrow_lamination')</a></li>
                                <li><a href="{{ uniqRt('microblading') }}" class="dez-page" title="@lang('silk-eyelash.microblading')">@lang('silk-eyelash.microblading')</a></li>
                                <li><a href="{{ uniqRt('wax-application') }}" class="dez-page" title="@lang('silk-eyelash.wax')">@lang('silk-eyelash.wax')</a></li>
                                <li><a href="{{ uniqRt('ice-laser-hair-removal') }}" class="dez-page" title="@lang('silk-eyelash.lazer-epilasyon')">@lang('silk-eyelash.lazer-epilasyon')</a></li>
                                <li><a href="{{ uniqRt('skin-care') }}" class="dez-page" title="@lang('silk-eyelash.skin-care')">@lang('silk-eyelash.skin-care')</a></li>
                                <li><a href="{{ uniqRt('cellulite-massage') }}" class="dez-page" title="@lang('silk-eyelash.cellulite-massage')">@lang('silk-eyelash.cellulite-massage')</a></li>
                                <li><a href="{{ uniqRt('roll-shape') }}" class="dez-page" title="@lang('silk-eyelash.roll-shape')">@lang('silk-eyelash.roll-shape')</a> </li>
                                <li><a href="{{ uniqRt('lip-coloring') }}" class="dez-page" title="@lang('silk-eyelash.lip_filler')">@lang('silk-eyelash.lip_filler')</a></li>
                                <li><a href="{{ uniqRt('keratin-care') }}" class="dez-page" title="@lang('silk-eyelash.keratin_care')">@lang('silk-eyelash.keratin_care')</a> </li>
                                <li><a href="{{ uniqRt('perming') }}" class="dez-page" title="@lang('silk-eyelash.perm')">@lang('silk-eyelash.perm')</a></li>
                                <li><a href="{{ uniqRt('brazillian-blow-dry') }}" class="dez-page" title="@lang('silk-eyelash.brazillian-blow-dry')">@lang('silk-eyelash.brazillian-blow-dry')</a></li>
                                <li><a href="{{ uniqRt('hair-color-highlights') }}" class="dez-page" title="@lang('silk-eyelash.highlighted')">@lang('silk-eyelash.highlighted')</a></li>
                                <li><a href="{{ uniqRt('hair-dye') }}" class="dez-page" title="@lang('silk-eyelash.hair_dye')">@lang('silk-eyelash.hair_dye')</a></li>
                                <li><a href="{{ uniqRt('hair-dip-dye') }}" class="dez-page" title="@lang('silk-eyelash.hair_dip_dye')">@lang('silk-eyelash.hair_dip_dye')</a></li>
                                <li><a href="{{ uniqRt('hair-cut') }}" class="dez-page" title="@lang('silk-eyelash.hair_cut')">@lang('silk-eyelash.hair_cut')</a> </li>
                                <li><a href="{{ uniqRt('hair-extension') }}" class="dez-page" title="@lang('silk-eyelash.hair_extension')">@lang('silk-eyelash.hair_extension')</a></li>
                                <li><a href="{{ uniqRt('bridal-hair') }}" class="dez-page" title="@lang('silk-eyelash.bridal_hair')">@lang('silk-eyelash.bridal_hair')</a></li>
                            </ul>
