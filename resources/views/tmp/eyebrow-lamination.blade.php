                        ...
                        <div class="col-lg-3 col-md-4">
                            <div class="sticky-top">
                                <ul class="service-list m-b30">
                                    <li><a href="{{ uniqRt('permanent-nail-polish') }}" class="dez-page" title="@lang('eyebrow-lamination.perminant_nail_polish')">@lang('eyebrow-lamination.perminant_nail_polish')</a></li>
                                    <li><a href="{{ uniqRt('manicure-pedicure') }}" class="dez-page" title="@lang('eyebrow-lamination.mani_pedi')">@lang('eyebrow-lamination.mani_pedi')</a></li>
                                    <li><a href="{{ uniqRt('prosthetic-nails') }}" class="dez-page" title="@lang('eyebrow-lamination.prosthetic_nail')">@lang('eyebrow-lamination.prosthetic_nail')</a></li>
                                    <li><a href="{{ uniqRt('nail-art') }}" class="dez-page" title="@lang('eyebrow-lamination.nail_art')">@lang('eyebrow-lamination.nail_art')</a></li>
                                    <li><a href="{{ uniqRt('silk-eyelash') }}" class="dez-page" title="@lang('eyebrow-lamination.silk_eyelash')">@lang('eyebrow-lamination.silk_eyelash')</a></li>
                                    <li><a href="{{ uniqRt('eyelash-lifting') }}" class="dez-page" title="@lang('eyebrow-lamination.eyelash_lifting')">@lang('eyebrow-lamination.eyelash_lifting')</a></li>
                                    <li><a href="{{ uniqRt('deepliner') }}" class="dez-page" title="@lang('eyebrow-lamination.dipliner')">@lang('eyebrow-lamination.dipliner')</a> </li>
                                    <li class="active"><a href="{{ uniqRt('eyebrow-lamination') }}" class="dez-page" title="@lang('eyebrow-lamination.eyebrow_lamination')">@lang('eyebrow-lamination.eyebrow_lamination')</a></li>
                                    <li><a href="{{ uniqRt('microblading') }}" class="dez-page" title="@lang('eyebrow-lamination.microblading')">@lang('eyebrow-lamination.microblading')</a></li>
                                    <li><a href="{{ uniqRt('wax-application') }}" class="dez-page" title="@lang('eyebrow-lamination.wax')">@lang('eyebrow-lamination.wax')</a></li>
                                    <li><a href="{{ uniqRt('ice-laser-hair-removal') }}" class="dez-page" title="@lang('eyebrow-lamination.lazer-epilasyon')">@lang('eyebrow-lamination.lazer-epilasyon')</a></li>
                                    <li><a href="{{ uniqRt('skin-care') }}" class="dez-page" title="@lang('eyebrow-lamination.skin-care')">@lang('eyebrow-lamination.skin-care')</a></li>
                                    <li><a href="{{ uniqRt('cellulite-massage') }}" class="dez-page" title="@lang('eyebrow-lamination.cellulite-massage')">@lang('eyebrow-lamination.cellulite-massage')</a></li>
                                    <li><a href="{{ uniqRt('roll-shape') }}" class="dez-page" title="@lang('eyebrow-lamination.roll-shape')">@lang('eyebrow-lamination.roll-shape')</a> </li>
                                    <li><a href="{{ uniqRt('lip-coloring') }}" class="dez-page" title="@lang('eyebrow-lamination.lip_filler')">@lang('eyebrow-lamination.lip_filler')</a></li>
                                    <li><a href="{{ uniqRt('keratin-care') }}" class="dez-page" title="@lang('eyebrow-lamination.keratin_care')">@lang('eyebrow-lamination.keratin_care')</a> </li>
                                    <li><a href="{{ uniqRt('perming') }}" class="dez-page" title="@lang('eyebrow-lamination.perm')">@lang('eyebrow-lamination.perm')</a></li>
                                    <li><a href="{{ uniqRt('brazillian-blow-dry') }}" class="dez-page" title="@lang('eyebrow-lamination.brazillian-blow-dry')">@lang('eyebrow-lamination.brazillian-blow-dry')</a></li>
                                    <li><a href="{{ uniqRt('hair-color-highlights') }}" class="dez-page" title="@lang('eyebrow-lamination.highlighted')">@lang('eyebrow-lamination.highlighted')</a></li>
                                    <li><a href="{{ uniqRt('hair-dye') }}" class="dez-page" title="@lang('eyebrow-lamination.hair_dye')">@lang('eyebrow-lamination.hair_dye')</a></li>
                                    <li><a href="{{ uniqRt('hair-dip-dye') }}" class="dez-page" title="@lang('eyebrow-lamination.hair_dip_dye')">@lang('eyebrow-lamination.hair_dip_dye')</a></li>
                                    <li><a href="{{ uniqRt('hair-cut') }}" class="dez-page" title="@lang('eyebrow-lamination.hair_cut')">@lang('eyebrow-lamination.hair_cut')</a> </li>
                                    <li><a href="{{ uniqRt('hair-extension') }}" class="dez-page" title="@lang('eyebrow-lamination.hair_extension')">@lang('eyebrow-lamination.hair_extension')</a></li>
                                    <li><a href="{{ uniqRt('bridal-hair') }}" class="dez-page" title="@lang('eyebrow-lamination.bridal_hair')">@lang('eyebrow-lamination.bridal_hair')</a></li>
                                </ul>
