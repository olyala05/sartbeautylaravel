                            ...
                            <div class="sticky-top">
                                <ul class="service-list m-b30">
                                    <li><a href="{{ route('pages.gelpolish') }}" class="dez-page"
                                            title="@lang('hair-cut.perminant_nail_polish')">@lang('hair-cut.perminant_nail_polish')</a></li>
                                    <li><a href="{{ route('pages.manicurepedicure') }}" class="dez-page"
                                            title="@lang('hair-cut.mani_pedi')">@lang('hair-cut.mani_pedi')</a></li>
                                    <li><a href="{{ route('pages.prostheticnails') }}" class="dez-page"
                                            title="@lang('hair-cut.prosthetic_nail')">@lang('hair-cut.prosthetic_nail')</a></li>
                                    <li><a href="{{ route('pages.nailart') }}" class="dez-page"
                                            title="@lang('hair-cut.nail_art')">@lang('hair-cut.nail_art')</a></li>
                                    ...
                                    <li><a href="{{ route('pages.microblading') }}" class="dez-page"
                                            title="@lang('hair-cut.microblading')">@lang('hair-cut.microblading')</a></li>
                                    <li><a href="{{ route('pages.shugaring') }}" class="dez-page"
                                            title="@lang('hair-cut.wax')">@lang('hair-cut.wax')</a></li>
                                    <li><a href="{{ route('pages.iselaser') }}" class="dez-page"
                                            title="@lang('hair-cut.lazer-epilasyon')">@lang('hair-cut.lazer-epilasyon')</a></li>
                                    <li><a href="{{ route('pages.skincare') }}" class="dez-page"
                                            title="@lang('hair-cut.skin-care')">@lang('hair-cut.skin-care')</a></li>
                                    <li><a href="{{ route('pages.cellulitemassage') }}" class="dez-page"
                                            title="@lang('hair-cut.cellulite-massage')">@lang('hair-cut.cellulite-massage')</a></li>
                                    <li><a href="{{ route('pages.rollshape') }}" class="dez-page"
                                            title="@lang('hair-cut.roll-shape')">@lang('hair-cut.roll-shape')</a> </li>
                                    <li><a href="{{ route('pages.lipcoloring') }}" class="dez-page"
                                            title="@lang('hair-cut.lip_filler')">@lang('hair-cut.lip_filler')</a></li>
                                    <li><a href="{{ route('pages.keratincare') }}" class="dez-page"
                                            title="@lang('hair-cut.keratin_care')">@lang('hair-cut.keratin_care')</a> </li>
                                    ...
                                    <li><a href="{{ route('pages.hairdye') }}" class="dez-page"
                                            title="@lang('hair-cut.hair_dye')">@lang('hair-cut.hair_dye')</a></li>
                                    <li><a href="{{ route('pages.hairdipdye') }}" class="dez-page"
                                            title="@lang('hair-cut.hair_dip_dye')">@lang('hair-cut.hair_dip_dye')</a></li>
                                    <li class="active"><a href="{{ route('pages.haircut') }}" class="dez-page"
                                            title="@lang('hair-cut.hair_cut')">@lang('hair-cut.hair_cut')</a> </li>
                                    <li><a href="{{ route('pages.hairextension') }}" class="dez-page"
                                            title="@lang('hair-cut.hair_extension')">@lang('hair-cut.hair_extension')</a></li>
                                    <li><a href="{{ route('pages.bridalhair') }}" class="dez-page"
                                            title="@lang('hair-cut.bridal_hair')">@lang('hair-cut.bridal_hair')</a></li>
                                </ul>
                                <div class="download-brochure m-b30 ">
                                    <h4 class="text-primary">@lang('hair-cut.sart_on_social_media')</h4>
                                    <p>@lang('hair-cut.follow_us_on_insta')</p>
                                    <a href="https://www.instagram.com/s.art.beauty" class="site-button"
                                        title="@lang('hair-cut.sart_official_center_instagram')" target="_blank">S.ART.BEAUTY</a>
                                </div>
                            </div>
                        </div>
